...
<meta charset="utf-8">
	...
	<title>Ajout d'un nouveau destination</title>
	...
	<script src="ajax/ajaxdst.js"></script>
</head>
<body>
<div class="container">
<p id="success"></p>
	<div class="table-wrapper">
		<div class="table-title">
			<div class="row">
				<div class="col-sm-6">
					<h2>Gestion <b><a href="indexdst.php">destination</a></b></h2>
				</div>
				<div class="col-sm-6">
					<a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"><i class="material-icons"></i> <span>Ajouter Nouvelle Destination</span></a>
		...
		<table class="table table-striped table-hover">
			...
			?>
			<tr id="<?php echo $row["id_dst"]; ?>">
			<td>
						<span class="custom-checkbox">
							<input type="checkbox" class="user_checkbox" data-user-id="<?php echo $row["id_dst"]; ?>">
				...
				<td>
					<a href="#editEmployeeModal" class="edit" data-toggle="modal">
						...
						data-id="<?php echo $row["id_dst"]; ?>"
						data-name="<?php echo $row["destination"]; ?>"
						title="Modifier"></i>
					</a>
					<a href="#deleteEmployeeModal" class="delete" data-id="<?php echo $row["id_dst"]; ?>" data-toggle="modal"><i class="fa fa-trash" data-toggle="tooltip" 
						title="Supprimer"></i></a>
				</td>
			</tr>
			<?php
		...
		<div class="modal-content">
			<form id="user_form">
				<div class="modal-header">						
					<h4 class="modal-title">Ajouter Destination</h4>
...
<div id="editEmployeeModal" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			<form id="update_form">
				<div class="modal-header">						
					<h4 class="modal-title">Modifier Destination</h4>
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
				</div>
				<div class="modal-body">
...
<div id="deleteEmployeeModal" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			<form>
				<div class="modal-header">						
					<h4 class="modal-title">Supprimer Destination</h4>
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
				</div>
				<div class="modal-body">
