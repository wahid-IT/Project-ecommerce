...
<head>
	...
	<title>Administrateur gére Image 1</title>
						...
						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Détails Image 1</div>
...
<div class="form-group">
												<label class="col-sm-4 control-label">Image actuelle 1</label>
<?php 
$id=intval($_GET['imgid']);
...
<?php }}?>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Télécharger une nouvelle image 1<span style="color:red">*</span></label>
												<div class="col-sm-8">
