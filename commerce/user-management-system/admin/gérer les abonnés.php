...
$query -> execute();
$msg="Informations sur l'abonné supprimées";
...
<head>
	...
	<title>Location de voitures |Administrateur Gére les abonnés  </title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Gestion des abonnés</h2>

						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">Détails des abonnés</div>
...
{				?>	
										...
										<td>
<a href="gérer les abonnés.php?del=<?php echo $result->id;?>" onclick="return confirm('Do you want to delete');"><i class="fa fa-close"></i></a>
</td>
