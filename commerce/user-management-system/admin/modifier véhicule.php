...
<head>
	...
	<title>Administrateur modifie les informations du véhicule</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Statistique du Chauffeur</h2>
...
<div class="col-sm-4">
<input type="text" name="vehicletitle" class="form-control" value="<?php echo htmlentities($result->nom_prenom_ch)?>" required>
</div>
<label class="col-sm-2 control-label">Sélectionnez la marque<span style="color:red">*</span></label>
<div class="col-sm-4">
<select class="selectpicker" name="brandname" required>
<option value="<?php echo htmlentities($result->direction);?>"><?php echo htmlentities($bdname=$result->service); ?> </option>
...
?>
<option value="<?php echo htmlentities($results->id_ch);?>"></option>
<?php }}} ?>
