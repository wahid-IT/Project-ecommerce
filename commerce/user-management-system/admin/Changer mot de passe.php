...
if(strlen($_SESSION['alogin'])==0)
	{	
header('location:http://localhost/commerce/user-management-system/index.php');
}
else{
...
$sql ="SELECT password_admin FROM admin WHERE username_admin=$username and password_admin=$password";
...
if($query -> rowCount() > 0)
{
$con="UPDATE admin set password_admin=$newpassword where username_admin=$username";
...
<head>
	...
	<title>Administrateur change le mot de passe</title>
