...
$(document).on('click','.update',function(e) {
    ...
    var objet=$(this).attr("data-email");
    var datem=$(this).attr("data-phone");
    var dater=$(this).attr("data-city");
    var destination=$(this).attr("data-destination");
    var moyen=$(this).attr("data-moyen");
    var missionnaire=$(this).attr("data-missionnaire");
    ...
    $('#moyen_u').val(moyen);
    $('#missionnaire_u').val(missionnaire);
